...
std::string openBaseString = "mishanya_description";
...
mishanya_description::KinematicsForward service;

ros::Time timeCurrent;
ros::Time timePrevious;

void onEncoderMessage(const mishanya_description::Velocity::ConstPtr& input){
...
int main(int argc, char **argv){
    ...
    kinematicsForwardWorld  = node.serviceClient<mishanya_description::KinematicsForward>("kinematics_forward_world" );
    kinematicsForwardMobile = node.serviceClient<mishanya_description::KinematicsForward>("kinematics_forward_mobile");
