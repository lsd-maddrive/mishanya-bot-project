...
mishanya_description::Velocity message;
...
int main(int argc, char **argv){
    ...
    ros::Subscriber subscriber = node.subscribe("/mishanya_description/joint_states", 1, onJointStateMessage);
    publisher = node.advertise<mishanya_description::Velocity>("wheel_velocity", 1);
    ros::spin();
    return 0;
}
