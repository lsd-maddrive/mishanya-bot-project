...
#include <mishanya_description/KinematicsForward.h>
...
bool mobileToWorld(mishanya_description::FrameToFrame::Request &request, mishanya_description::FrameToFrame::Response &response) {
...
bool worldToMobile(mishanya_description::FrameToFrame::Request &request, mishanya_description::FrameToFrame::Response &response) {
    worldToMobileCore(request.input.x, request.input.y, response.output.x, response.output.y);
}

bool forwardMobile(mishanya_description::KinematicsForward::Request &request, mishanya_description::KinematicsForward::Response &response) {
...
bool forwardWorld(mishanya_description::KinematicsForward::Request &request, mishanya_description::KinematicsForward::Response &response) {
    forwardMobile(request, response);
    mobileToWorldCore(response.output.x, response.output.y, response.output.x, response.output.y);
    return true;
}

bool inverseMobile(mishanya_description::KinematicsInverse::Request &request, mishanya_description::KinematicsInverse::Response &response) {
...
bool inverseWorld(mishanya_description::KinematicsInverse::Request &request, mishanya_description::KinematicsInverse::Response &response) {
