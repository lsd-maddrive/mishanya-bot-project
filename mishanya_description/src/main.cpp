...
#include <mishanya_description/FrameToFrame.h>
#include <mishanya_description/KinematicsInverse.h>
#include <mishanya_description/Movement.h>
#include <mishanya_description/MovementBezier.h>
#include <mishanya_description/MovementGeneric.h>
#include <mishanya_description/Velocity.h>
...
mishanya_description::FrameToFrame mobileToWorld;

long double I;

mishanya_description::KinematicsInverse kinematicsInverse;
...
mishanya_description::Velocity velocity;
...
void onCommandMessage(const mishanya_description::Movement::ConstPtr& input){
    if (input->movement == mishanya_description::Movement::BEZIER) {
        if (input->bezier.frame == mishanya_description::Movement::MOBILE) {
    ...
    } else if (input->movement == mishanya_description::Movement::WHEEL) {
    ...
    } else if (input->movement == mishanya_description::Movement::GENERIC) {
        if (input->generic.type == mishanya_description::Movement::POSITION_ABSOLUTE) {
            if (input->generic.frame == mishanya_description::Movement::WORLD) {
            ...
            } else if (input->generic.frame == mishanya_description::Movement::MOBILE) {
        ...
        } else if (input->generic.type == mishanya_description::Movement::POSITION_RELATIVE) {
            if (input->generic.frame == mishanya_description::Movement::WORLD) {
            ...
            if (input->generic.frame == mishanya_description::Movement::MOBILE) {
            ...
            } else if (input->generic.frame == mishanya_description::Movement::WORLD) {
...
int main(int argc, char **argv) {
    ...
    kinematicsInverseMobileClient = node.serviceClient<mishanya_description::KinematicsInverse>("kinematics_inverse_mobile");
    kinematicsInverseWorldClient  = node.serviceClient<mishanya_description::KinematicsInverse>("kinematics_inverse_world" );
    kinematicsMobileToWorldClient = node.serviceClient<mishanya_description::FrameToFrame>("kinematics_mobile_to_world");
