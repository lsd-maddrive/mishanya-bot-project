...
void setBaseSpeed(float vxGlobal, float vyGlobal, float angularSpeed) {
    ...
    angularSpeedWheel2 = (1/R) * ((-1) * vxGlobal * cosf(realAngleZ * GRAD_TO_RAD + THETA_1) - vyGlobal * sinf(realAngleZ * GRAD_TO_RAD + THETA_1) + L * angularSpeed);
    angularSpeedWheel3 = (1/R) * ((-1) * vxGlobal * sinf(realAngleZ * GRAD_TO_RAD + THETA_2) + vyGlobal * cosf(realAngleZ * GRAD_TO_RAD + THETA_2) + L * angularSpeed);
