...
const pwm_channel_t ch_left_pwm = {.alt_func_1 = 2, .ch_pwm_1 = 0};
...
const line_driver_t left_control = {
    .PWM_1 = LEFT_PWM, .digit_2 = LEFT_DOWN, .digit_1 = LEFT_UP};
...
const pwm_channel_t ch_right_pwm = {.alt_func_1 = 2, .ch_pwm_1 = 1};
...
const line_driver_t right_control = {
    .PWM_1 = RIGHT_PWM, .digit_2 = RIGHT_DOWN, .digit_1 = RIGHT_UP};
...
const arm_driver_ctx_t elbow_driver = {
    .type = RED, .arm[0] = left_arm, .arm[1] = right_arm};
...
const pwm_channel_t ch_left_pwm = {
    .ch_pwm_1 = 0, .ch_pwm_2 = 0, .alt_func_1 = 1, .alt_func_2 = 1};

const pwm_ctx_t left_pwm_ctx = {
    .pwm_ch = ch_left_pwm,
    .driver_ptr = &PWMD1,
    .pwm_conf = {.frequency = PWM_frequency,
                 .period = PWM_period,
                 .callback = NULL,
                 .channels = {{.mode = PWM_OUTPUT_ACTIVE_HIGH |
                                       PWM_COMPLEMENTARY_OUTPUT_ACTIVE_HIGH,
                               .callback = NULL}, // LEFT_PWM

                              {.mode = PWM_OUTPUT_ACTIVE_HIGH |
                                       PWM_COMPLEMENTARY_OUTPUT_ACTIVE_HIGH,
                               .callback = NULL}, // RIGHT_PWM

                              {.mode = PWM_OUTPUT_DISABLED, .callback = NULL},

                              {.mode = PWM_OUTPUT_DISABLED, .callback = NULL}},
                 .cr2 = 0,
                 // !!!!!!!! THE CALCULATION WAS MADE FOR A CLOCK FREQUENCY OF 8
                 // MHz AND THE APB1 BUS !!!!!!!! //
                 .bdtr = 0b10011100,
                 // !!!!!!!! THE CALCULATION WAS MADE FOR A CLOCK FREQUENCY OF 8
                 // MHz AND THE APB1 BUS !!!!!!!! //
                 .dier = 0}};

const line_driver_t left_control = {.PWM_1 = LEFT_PWM_1,
                                    .PWM_2 = LEFT_PWM_2,
                                    .digit_1 = LEFT_UP,
                                    .digit_2 = LEFT_DOWN};

const control_driver_t left_arm = {.line_control = left_control,
                                   .arm_ctx = left_pwm_ctx};
...
const pwm_channel_t ch_right_pwm = {
    .ch_pwm_1 = 1, .ch_pwm_2 = 1, .alt_func_1 = 1, .alt_func_2 = 1};
...
const line_driver_t right_control = {.PWM_1 = RIGHT_PWM_1,
                                     .PWM_2 = RIGHT_PWM_2,
                                     .digit_1 = RIGHT_UP,
                                     .digit_2 = RIGHT_DOWN};

const control_driver_t right_arm = {.line_control = right_control,
                                    .arm_ctx = right_pwm_ctx};
...
const arm_driver_ctx_t elbow_driver = {
    .type = BB, .arm[0] = left_arm, .arm[1] = right_arm};
 ...
 */
void elbow_init(void) { driver_init(&elbow_driver); }
 ...
 */
void elbow_off(arm_side_t side) { arm_off(side, &elbow_driver); }
