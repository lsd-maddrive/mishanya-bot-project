...
// *******************elbow driver pin config******************* //
	...
	#define LEFT_PWM		PAL_LINE(GPIOE,13) // TIM1 CH3 AF1
	#define RIGHT_PWM		PAL_LINE(GPIOC,9) // TIM8 CH4 AF3

    #define LEFT_UP			PAL_LINE(GPIOB,1)
    #define LEFT_DOWN		PAL_LINE(GPIOB,15)
    #define RIGHT_UP		PAL_LINE(GPIOD,13)
    #define RIGHT_DOWN	    PAL_LINE(GPIOB,2)
	...
	#define LEFT_HIN_1 PAL_LINE(GPIOE,11) //TIM1_CH3 AF1
	#define LEFT_LIN_1 PAL_LINE(GPIOE,10)
	#define LEFT_LIN_2 PAL_LINE(GPIOE,13)
	#define LEFT_HIN_2 PAL_LINE(GPIOE,12)

    #define RIGHT_HIN_1 PAL_LINE(GPIOC,6)
    #define RIGHT_LIN_1 PAL_LINE(GPIOA,5)
    #define RIGHT_LIN_2 PAL_LINE(GPIOC,7)
    #define RIGHT_HIN_2 PAL_LINE(GPIOB,0)
