...
// *******************elbow driver pin config******************* //
	...
	#define LEFT_PWM_ELBOW         PAL_LINE(GPIOE,13) // TIM1 CH3 AF1 elbow
    #define RIGHT_PWM_ELBOW        PAL_LINE(GPIOC,9) // TIM8 CH4 AF3 elbow
...
PID_t shoulder_in_PID = {
  .coef = {.kp = 3500, .ki = 500, .kd = 0},
  .error = {.P = 0, .prev_P = 0, .I = 0, .D = 0}
};
PID_t shoulder_out_PID = {
  .coef = {.kp = 3500, .ki = 500, .kd = 0},
  .error = {.P = 0, .prev_P = 0, .I = 0, .D = 0}
};
...
// ***********************left arm config*********************** //
  ...
  arm_encoder_t left_shoulder_in_encoder =
  {
    .encoder_ptr = &SPID2,
    .encoder_pins = {
  ...
  arm_encoder_t left_shoulder_out_encoder =
  {
    .encoder_ptr = &SPID2,
    .encoder_pins = {
...
// ***********************right arm config*********************** //
  ...
  arm_encoder_t right_shoulder_in_encoder =
  {
    .encoder_ptr = &SPID2,
    .encoder_pins = {
  ...
  arm_encoder_t right_shoulder_out_encoder =
  {
    .encoder_ptr = &SPID2,
    .encoder_pins = {
...
traking_cs_t left_cs_elbow;
traking_cs_t right_cs_elbow;
traking_cs_t left_cs_shoulder_in;
traking_cs_t right_cs_shoulder_in;
traking_cs_t left_cs_shoulder_out;
traking_cs_t right_cs_shoulder_out;
arm_system_t right_system_elbow;
arm_system_t left_system_elbow;
arm_system_t right_system_shoulder_in;
arm_system_t left_system_shoulder_in;
arm_system_t right_system_shoulder_out;
arm_system_t left_system_shoulder_out;
...
{
  // init left_cs struct
  left_cs_elbow.angle_lim = left_angle_lim_elbow;
  left_cs_elbow.angle_dead_zone = ENCODER_DEADZONE;
  left_cs_elbow.arm_PID = elbow_PID;
  left_cs_elbow.arm_encoder = left_elbow_encoder;

  left_cs_elbow.angle_lim = left_angle_lim_shoulder_in;
  left_cs_elbow.angle_dead_zone = ENCODER_DEADZONE;
  left_cs_elbow.arm_PID = shoulder_in_PID;
  left_cs_elbow.arm_encoder = left_shoulder_in_encoder;

  left_cs_elbow.angle_lim = left_angle_lim_shoulder_out;
  left_cs_elbow.angle_dead_zone = ENCODER_DEADZONE;
  left_cs_elbow.arm_PID = shoulder_out_PID;
  left_cs_elbow.arm_encoder = left_shoulder_out_encoder;

  // init right_system struct
  left_system_elbow.traking_cs = left_cs_elbow;
  left_system_elbow.control = left_arm_elbow;

  left_system_elbow.traking_cs = left_cs_shoulder_in;
  left_system_elbow.control = left_arm_shoulder_in;

  left_system_elbow.traking_cs = left_cs_shoulder_out;
  left_system_elbow.control = left_arm_shoulder_out;

  // init right_cs struct
  right_cs_elbow.angle_lim = right_angle_lim_elbow;
  right_cs_elbow.angle_dead_zone = ENCODER_DEADZONE;
  right_cs_elbow.arm_PID = elbow_PID;
  right_cs_elbow.arm_encoder = right_elbow_encoder;

  right_cs_elbow.angle_lim = right_angle_lim_shoulder_in;
  right_cs_elbow.angle_dead_zone = ENCODER_DEADZONE;
  right_cs_elbow.arm_PID = shoulder_in_PID;
  right_cs_elbow.arm_encoder = right_shoulder_in_encoder;

  right_cs_elbow.angle_lim = right_angle_lim_shoulder_out;
  right_cs_elbow.angle_dead_zone = ENCODER_DEADZONE;
  right_cs_elbow.arm_PID = shoulder_out_PID;
  right_cs_elbow.arm_encoder = right_shoulder_out_encoder;


  // init right_system struct
  right_system_elbow.traking_cs = right_cs_elbow;
  right_system_elbow.control = right_arm_elbow;

  right_system_elbow.traking_cs = right_cs_shoulder_in;
  right_system_elbow.control = right_arm_shoulder_in;

  right_system_elbow.traking_cs = right_cs_shoulder_out;
  right_system_elbow.control = right_arm_shoulder_out;
  ...
  arm_driver.arm[0] = left_system_elbow;
  arm_driver.arm[1] = left_system_shoulder_in;
  arm_driver.arm[2] = left_system_shoulder_out;
  arm_driver.arm[3] = right_system_elbow;
  arm_driver.arm[4] = right_system_shoulder_in;
  arm_driver.arm[5] = right_system_shoulder_out;
